...
desktop: "hidden lg:flex flex-col fixed top-30 left-0 h-[calc(100vh-64px)] w-64 bg-white border-r border-gray-200",
...
export const STATS_GRID = "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4 mb-4 md:mb-6"
